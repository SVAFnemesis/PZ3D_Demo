...
/// <summary>
/// This Module Is For Caching Player Control Status, It Provides State Query
/// </summary>
public class PlayerControlModule : MonoBehaviour
{
    ...
    /// <summary>
    /// -1 crouch, 0 standing, 1 jump(toggle only)
    /// </summary>
    ...
    public float m_Xaxis;//mouse
    public float m_Yaxis;//mouse
    public float m_midScroll;//mouse
    ...
    [Header("Assign TPS Node To ", order = 0)]
    [Space(-10, order = 1)]
    [Header("initiate as foot mount", order = 2)]
    [Space(0, order = 3)]
    /// <summary>
    ...
    private void keyScanMouse()
    {
        ...
        m_midScroll = Input.GetAxis("Mouse ScrollWheel");
    }
